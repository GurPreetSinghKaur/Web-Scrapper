        ...
        int numberOfPage = 1;
            try {
                ...
                for (int pagination = 1; pagination <= numberOfPage; pagination++) {
                    ...
                    Elements elementPagination = document.select(".Paginationstyles__PageNumbers-sc-1temk9l-2.bHHNyv.xs-row.sm-hidden");
                    //clean out
                    String[] paginationArray = elementPagination.text().split("of");
                    //set the total number of pages
                    numberOfPage = Integer.parseInt(paginationArray[1].replace(" ",""));
                    //get the name
                    Elements elementName = document.select(".PQnCV");
