...
public class Utility {
    //Define Variables
    private final String[] colorMatches = new String[] {"Black","Blue Titanium","Natural Titanium", "Blue", "Purple","Sierra" ,"White","Grey" , "Green", "Graphite", "Coral", "Red","RED", "Pacific Blue", "Gold", "Yellow", "Space Grey", "Silver", "Coral", "RED","Red", "Pink", "Starlight", "Rose Gold", "Jet Black", "Midnight", "MIDNIGHT","Natural"};
    private final String[] sizeMatches = new String[] {"16gb","32gb","64 GB","1tb", "128 GB","128gb","64gb","256gb","256 GB","64GB", "128GB", "256GB", "512 GB", "512GB", "512gb", "1TB", "1 TB"};
